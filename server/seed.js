...
module.exports = {
  seed: (req, res) => {
    ...
    drop table if exists customer;
        ...
        insert into customer (customer_name, email, password, phone_number, pricing_tier)
        values 
        ('Secure Water', 'info@securewater.net', 'secure1!', '4041232222', 'elite-50%'),
        ('Dakota Water Supply', 'contact@dws.com', 'dakota2@', '5034010539', 'premium-35%'),
        ('Water Resource', 'wrc@gmail.com', 'water3#', '2052351478', 'associate-25%');
        ...
        insert into customer_order(customer_id, order_number, order_date, meter_qty, meter_id, order_total, discounted_total)
         values 
